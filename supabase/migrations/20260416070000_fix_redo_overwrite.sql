-- Fix compress_lesson_events to use the FIRST step_complete instead of the latest
-- This prevents redo attempts from overwriting original completion data
...
BEGIN
  ...
  LOOP
    ...
    -- Use the FIRST step_complete to preserve original attempt data (ignore redos)
